<template>
  <div class="personnel-information-table">
    ...
    <el-table :data="filteredData" style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="studentInstructor" label="班主任"></el-table-column>
    ...
    <el-dialog v-model="editDialogVisible" title="编辑信息">
      <el-form :model="editForm" label-width="80px">
        ...
        <el-form-item label="班级">
          <el-input v-model="editForm.studentClass"></el-input>
        </el-form-item>
        <el-form-item label="班主任">
          <el-input v-model="editForm.studentInstructor"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog v-model="addDialogVisible" title="添加用户">
      <el-form :model="addForm" label-width="80px">
        ...
        <el-form-item label="班主任">
          <el-input v-model="addForm.studentInstructor"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
...
export default defineComponent({
  ...
  setup() {
    const state = reactive({
      ...
      editForm: {name: "", age: null, gender: "", contactInfo: "", studentClass: "", studentInstructor: ""},
      addForm: {name: "", age: null, gender: "", contactInfo: "", studentClass: "", studentInstructor: ""},
    });
          ...
          .then((response) => {
            ...
            if (Array.isArray(data)) {
              state.allTableData = data.map((item) => ({
                ...
                studentInstructor: item.studentInstructor,
              }));
    ...
    const saveEdit = () => {
      // 更新逻辑（假设后台有相应的更新接口）
      axios
          .put(`${import.meta.env.VITE_BASE_URL}/api/v1/student/${state.editForm.id}`, state.editForm, {
            headers: {
    ...
    const deletePersonnel = (id) => {
      axios
          .delete(`${import.meta.env.VITE_BASE_URL}/api/v1/student/${id}`, {
            headers: {
              token: getToken(),
            },
          })
    ...
    const saveAdd = () => {
      const data = {
        ...
        age: state.addForm.age,
        gender: state.addForm.gender,
        contactInfo: state.addForm.contactInfo,
        studentClass: state.addForm.studentClass,
        studentInstructor: state.addForm.studentInstructor,
      };

      axios
          .post(`${import.meta.env.VITE_BASE_URL}/api/v1/student`, data, {
            headers: {
              "Content-Type": "application/json",
              token: getToken(),
            },
          ...
          .finally(() => {
            ...
            state.addForm = {name: "", age: null, gender: "", contactInfo: "", studentClass: "", studentInstructor: ""};
          });
    };
